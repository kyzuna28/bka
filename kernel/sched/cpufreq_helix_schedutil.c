...
static int helix_init(struct cpufreq_policy *policy) {
    return hxgov_init(policy);
}

static void helix_exit(struct cpufreq_policy *policy) {
    hxgov_exit(policy);
}

static int helix_start(struct cpufreq_policy *policy) {
    return hxgov_start(policy);
}

static void helix_stop(struct cpufreq_policy *policy) {
    hxgov_stop(policy);
}

static void helix_limits(struct cpufreq_policy *policy) {
    hxgov_limits(policy);
}
