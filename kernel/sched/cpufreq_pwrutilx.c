...
static int pwrutilx_init(struct cpufreq_policy *policy) {
    return pwrgov_init(policy);
}

static void pwrutilx_exit(struct cpufreq_policy *policy) {
    pwrgov_exit(policy);
}

static int pwrutilx_start(struct cpufreq_policy *policy) {
    return pwrgov_start(policy);
}

static void pwrutilx_stop(struct cpufreq_policy *policy) {
    pwrgov_stop(policy);
}

static void pwrutilx_limits(struct cpufreq_policy *policy) {
    pwrgov_limits(policy);
}
...
struct cpufreq_governor cpufreq_gov_pwrutilx = {
    ...
    .init   = pwrutilx_init,
    .exit   = pwrutilx_exit,
    .start  = pwrutilx_start,
    .stop   = pwrutilx_stop,
    .limits = pwrutilx_limits,
    .owner  = THIS_MODULE,
};
