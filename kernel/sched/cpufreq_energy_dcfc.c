...
static int energy_init(struct cpufreq_policy *policy) {
    return nrggov_init(policy);
}

static void energy_exit(struct cpufreq_policy *policy) {
    nrggov_exit(policy);
}

static int energy_start(struct cpufreq_policy *policy) {
    return nrggov_start(policy);
}

static void energy_stop(struct cpufreq_policy *policy) {
    nrggov_stop(policy);
}

static void energy_limits(struct cpufreq_policy *policy) {
    nrggov_limits(policy);
}
